...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('foskym/flarum-wysiwyg-editor', function () {
  console.log('[foskym/flarum-wysiwyg-editor] Hello, admin!');
});
